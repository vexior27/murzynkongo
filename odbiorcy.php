    ...
    <div id="main">
        <div>
            <form action="odbiorcy.php" method="POST">
                ...
                <input type="submit" value="Dodaj odbiorce" class="add-btn" >
            </form>
        </div>
        <?php 
            ...
            if(isset($_POST['imie']) && isset($_POST['naz']) && isset($_POST['email']) && isset($_POST['tel']) && isset($_POST['typ']) && isset($_POST['ul']) && isset($_POST['nrd']) && isset($_POST['kodp']) && isset($_POST['miasto']) ){
                ...
                $kwer = mysqli_prepare($conn, "INSERT INTO odbiorca(imie_o,nazwisko_o,email_o,telefon_o,typ_o,ulica_o,nr_domu_o,nr_lokalu_o,kod_o,miasto_o) VALUES (?,?,?,?,?,?,?,?,?,?)");
